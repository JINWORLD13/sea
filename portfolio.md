...
**'자율운항 및 해양 AI 인지'** 기술에 영감을 받아 제작한 **실시간 선박 모니터링 및 디지털 트윈 인터페이스** 프로젝트입니다. 전 세계 실시간 AIS(Automatic Identification System) 데이터를 활용하여 선박의 위치를 추적하고, IoT 센서 데이터를 시각화하여 지능형 항만 및 운항 관제 시스템의 프론트엔드를 구현했습니다.
